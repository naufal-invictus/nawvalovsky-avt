        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
                ...
                <div>
                   ...
                   <div className="mt-4 flex gap-6 text-xs font-bold text-[var(--text-secondary)] uppercase tracking-wider">
                      <div className="group cursor-default hover:text-[var(--accent)] transition-colors">
                        {/* CONTRAST FIX: Opacity increased to 80% */}
                        <span className="block text-[10px] font-normal opacity-80">1st</span>Logic
                      </div>
                      <div className="group cursor-default hover:text-[var(--accent)] transition-colors">
                        <span className="block text-[10px] font-normal opacity-80">2nd</span>Physics
                      </div>
                      <div className="group cursor-default hover:text-[var(--accent)] transition-colors">
                        <span className="block text-[10px] font-normal opacity-80">3rd</span>Emotion
                      </div>
                      <div className="group cursor-default hover:text-[var(--accent)] transition-colors">
                        <span className="block text-[10px] font-normal opacity-80">4th</span>Volition
                      </div>
                   </div>
                </div>
          ...
          <div className="flex-1 lg:w-4/12 flex flex-col justify-center">
             ...
             <div className="grid grid-cols-2 gap-4 md:gap-6">
                ...
                {/* Ne - CONTRAST FIX: Red color darkened, opacity removed */}
                <div className="col-span-1 p-4 rounded-2xl border border-[var(--border-dim)] border-dashed hover:opacity-100 transition-opacity bg-red-500/5 hover:bg-red-500/10">
                   <span className="text-[10px] font-mono uppercase text-red-600 block mb-1">Inferior</span>
