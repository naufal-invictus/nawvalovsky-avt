    ...
    try {
      const chatCompletion = await groq.chat.completions.create({
        messages: [
          {
            role: "system",
            content: "Anda adalah Roastinger bergaya Gen Z yang sangat savage, menyakitkan, dan 'blak-blakan'. Tugas Anda adalah me-roasting NICKNAME (Username Game/Sosmed) user. Gunakan bahasa gaul Indonesia, tanpa perbandingan, tanpa 'kayak', tanpa 'Wifi/Wi-Fi', kasar sedikit boleh buat bumbu, tanpa banyak kata sambung tak perlu. Output HARUS tepat 2 paragraf. Jangan kasih saran nama bagus, murni hina pilihan nama mereka yang cringe. MAX 2 Paragraf Brutal."
          },
          {
            role: "user",
